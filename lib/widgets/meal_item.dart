...
import 'package:foodie_ui_app/widgets/meal_item_trait.dart';
import 'package:transparent_image/transparent_image.dart';

class MeatItem extends StatelessWidget {
  const MeatItem({super.key, required this.meal, required this.onSelectMeal});
  ...
  // void _ontappingImage(BuildContext context) {
  //
